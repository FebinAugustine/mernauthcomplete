...
import AddUser from "../components/evngCordinator/addUser";

const EvngCordinatorDashboard = () => {
  ...
  const sidebarItems = [
    ...
    { id: "", label: "EVANGELISM COORDINATOR TOOLS", icon: "" },
...
export default EvngCordinatorDashboard;
