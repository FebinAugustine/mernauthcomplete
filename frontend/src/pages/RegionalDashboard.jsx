...
import AddZone from "../components/regional/addZone";
import AddSubZone from "../components/regional/addSubZone";
import AddFellowship from "../components/regional/addFellowship";
import AddUser from "../components/regional/addUser";
...
const RegionalDashboard = () => {
  ...
  const sidebarItems = [
    ...
    { id: "", label: "REGIONAL TOOLS", icon: "" },
    { id: "add-zone", label: "Add Zone", icon: "🏞️" },
          ...
          {sidebarItems.map((item) =>
            item.id === "" ? (
              ...
              <button
                ...
                className={`w-full flex flex-col md:flex-row items-center md:px-6 py-4 text-left hover:bg-gray-100 ${
                  activeTab === item.id
